...
namespace NPF_Teste
{
    public class Calculator
    {
        ...
        /// 
        /// </summary>
        /// <param name="numbers">String numbers List</param>
        /// <returns>List numbers/multiplicity</returns>
        public static List<Result> IsMultipleOf11(List<string> numbers)
        {
            ...
            foreach (string n in numbers) // para cada item na lista de entrada
            {
                ...
                try
                {
                    if (size > 2) /******* para numeros maiores ********/
                    {
                    ...
                    else /******* para numeros pequenos (dois digitos) ********/
                    {
